...
function generateCatalog(records) {
  ...
  return `// Mock book catalog — backs Job 1 / Product-Service 1 (tìm kiếm từ khóa + gợi ý AI).
...
function generateAvailability(records) {
  ...
  return `// Mock real-time availability — backs Gain Creator 4 / Pain Reliever 2
...
function generateLibraryMap(records) {
  ...
  return `// Mock library floor map / shelf location — backs Product-Service 2 / Gain Creator 2
